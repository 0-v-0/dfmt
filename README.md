...
tab_width | positive integers, `none` (**`4`**) | [See EditorConfig documentation.](https://github.com/editorconfig/editorconfig/wiki/EditorConfig-Properties#tab_width) `none` leaves `tab_width` unset, so `dfmt` keeps using its default width.
